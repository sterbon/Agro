...
if [[ "$(docker images -q eosio-agro:eos2.0.0-cdt1.6.3)" == "" ]]; then
  echo "=== Build docker image eosio-agro version eos2.0.0-cdt1.6.3, this will take some time for the first time run ==="
  docker build -t eosio-agro:eos2.0.0-cdt1.6.3 .
else
