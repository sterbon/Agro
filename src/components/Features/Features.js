            ...
            <div className="features-grid-container">
                <div className="features-grid-top">
                    <div className="features-card">
                        <img src={penny} width="55px" height="55px"/>
                    ...
                    <div className="features-card">
                        <img src={risk} width="55px" height="55px"/>
                        <h3>EOS, risk-free</h3>
                    ...
                    <div className="features-card">
                        <img src={safety} width="55px" height="55px"/>
                        <h3>Safety first</h3>
                ...
                <div className="features-grid-bottom">
                    <div className="features-card">
                        <img src={freedom} width="55px" height="55px"/>
                    ...
                    <div className="features-card">
                        <img src={open} width="55px" height="55px"/>
                    ...
                    <div className="features-card">
                        <img src={upgrade} width="55px" height="55px"/>
